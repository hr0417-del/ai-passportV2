  ...
  return new Promise((resolve, reject) => {
    ...
    const req = https.request(url, {
      ...
      if (res.statusCode >= 300 && res.statusCode < 400 && res.headers.location) {
        ...
        // For POST redirect, follow GET/POST to redirect URL
...
async function testPost() {
  console.log('Sending test POST request to Google Apps Script Webhook...');
  const testRegistration = {
    fullname: "Test Registration SyncCheck",
    email: "test_synccheck_" + Date.now() + "@aipassport.org",
    mobile: "9998887776",
    role: "School Teacher",
    use_case: "Test Webhook",
    city: "New Delhi"
  };
