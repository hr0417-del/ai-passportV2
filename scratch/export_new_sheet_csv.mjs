...
async function exportNewSheet() {
  ...
  console.log(`✅ Saved New Sheet CSV file on Desktop: ${desktopCsvPath}`);
  console.log(`📊 Total Registrations Included: ${csvRows.length - 1}`);
}

exportNewSheet().catch(console.error);
