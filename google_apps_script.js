...
<head>
  ...
  <style type="text/css">
    ...
    .btn-gold {
      background: linear-gradient(135deg, #DFCFAD 0%, #C5A880 100%);
...
<body style="margin: 0; padding: 0; background-color: #06080F; color: #E2E8F0; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
        ...
        <table class="email-container" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; width: 100%; background-color: #0D101A; border: 1px solid rgba(223, 207, 173, 0.3); border-radius: 20px; padding: 40px 32px; box-shadow: 0 20px 50px rgba(0,0,0,0.8);">
          ...
          <tr>
            <td align="center" style="padding-bottom: 24px;">
              <span style="font-family: 'Space Mono', monospace, Arial; font-size: 11px; font-weight: 700; color: #DFCFAD; letter-spacing: 0.25em; text-transform: uppercase; display: block; margin-bottom: 6px;">
                EKAAKSHAR EDUCATION
              </span>
              <h1 style="font-size: 22px; font-weight: 800; color: #FFFFFF; letter-spacing: 0.15em; margin: 0; text-transform: uppercase;">
                AI PASSPORT™
              </h1>
            </td>
          </tr>

          <!-- Hero Image of AI Passport Card -->
          <tr>
          ...
          <!-- Headline & Confirmation Notice -->
          <tr>
            <td align="left" style="padding-bottom: 24px;">
              <span style="font-size: 11px; font-weight: 700; color: #2ECC71; letter-spacing: 0.2em; text-transform: uppercase; display: block; margin-bottom: 8px;">
                ✓ SEAT CONFIRMED &bull; FREE REGISTRATION
              </span>
              <h2 style="font-size: 24px; font-weight: 700; color: #FFFFFF; margin: 0 0 10px 0; line-height: 1.3;">
                Your Seat is Confirmed for AI Passport Live™
              </h2>
              <div style="background: rgba(223, 207, 173, 0.08); border-left: 3px solid #DFCFAD; padding: 12px 16px; border-radius: 4px; margin-bottom: 16px;">
                <p style="font-size: 13px; font-weight: 700; color: #DFCFAD; margin: 0; text-transform: uppercase; letter-spacing: 0.05em;">
              ...
              <p style="font-size: 15px; line-height: 1.65; color: #CBD5E1; margin: 0;">
                Dear <strong>` + userFullName + `</strong>,<br><br>
                Welcome to AI Passport Live™. AI Passport™ is a growing record of what you learn, what you build and what you can prove with AI. We look forward to seeing you at this practical 90-minute live experience.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding-bottom: 32px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #141824; border: 1px solid rgba(255,255,255,0.08); border-radius: 14px; padding: 20px;">
                <tr>
                  <td style="padding-bottom: 10px; font-size: 13px; color: #94A3B8;">PASSPORT ID</td>
                  <td align="right" style="padding-bottom: 10px; font-size: 14px; font-weight: 700; color: #DFCFAD; font-family: monospace;">` + passportId + `</td>
                </tr>
                <tr>
                  <td style="padding-bottom: 10px; font-size: 13px; color: #94A3B8;">DATE</td>
                  <td align="right" style="padding-bottom: 10px; font-size: 14px; font-weight: 700; color: #FFFFFF;">Sunday, 20 September 2026</td>
                </tr>
                <tr>
                  <td style="padding-bottom: 10px; font-size: 13px; color: #94A3B8;">TIME</td>
                  <td align="right" style="padding-bottom: 10px; font-size: 14px; font-weight: 700; color: #DFCFAD;">2:00 PM – 3:30 PM IST</td>
                </tr>
                <tr>
                  <td style="padding-bottom: 10px; font-size: 13px; color: #94A3B8;">REGISTERED ROLE</td>
                  <td align="right" style="padding-bottom: 10px; font-size: 14px; font-weight: 600; color: #FFFFFF;">` + userRole + `</td>
                </tr>
                <tr>
                  <td style="font-size: 13px; color: #94A3B8;">ACCESS</td>
                  <td align="right" style="font-size: 14px; font-weight: 700; color: #2ECC71;">90 MINS &bull; LIVE &bull; FREE</td>
                </tr>
              </table>
            </td>
          </tr>

          <!-- Action Buttons: Add to Calendar + Share on WhatsApp -->
          <tr>
            <td align="center" style="padding-bottom: 36px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="center">
                    <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=AI+Passport+Live%3A+AI+in+Education+%E2%80%93+Preparing+the+Teacher+for+Viksit+Bharat&dates=20260920T083000Z/20260920T100000Z&details=A+free+90-minute+live+experience+for+teachers+and+educators.+Official+Portal%3A+https%3A%2F%2Faipassport.ekaakshareducation.com%2Flive.html&location=Online+Live+Webinar" target="_blank" class="btn-gold btn-stack" style="margin-right: 8px; margin-bottom: 10px;">
                      📅 ADD TO GOOGLE CALENDAR
                    </a>
                    <a href="https://api.whatsapp.com/send?text=I%20just%20registered%20for%20AI%20Passport%20Live%E2%84%A2%3A%20AI%20in%20Education%20%E2%80%93%20Preparing%20the%20Teacher%20for%20Viksit+Bharat%20(20%20September%202026).%20Register%20your%20free%20seat%20here%3A%20https%3A%2F%2Faipassport.ekaakshareducation.com%2Flive.html" target="_blank" class="btn-whatsapp btn-stack" style="margin-bottom: 10px;">
                      💬 SHARE ON WHATSAPP
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding-bottom: 32px; border-top: 1px solid rgba(255,255,255,0.08); padding-top: 28px;">
              <h3 style="font-size: 16px; font-weight: 700; color: #FFFFFF; margin: 0 0 16px 0;">
